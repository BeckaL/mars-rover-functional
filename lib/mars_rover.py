...
def turn(mars_rover: MarsRover, clockwise: bool) -> MarsRover:
    ...
    next_index = current_direction_index + 1 if clockwise else current_direction_index - 1
    return update_mars_rover_direction(mars_rover, directions_list[next_index % len(directions_list)])
